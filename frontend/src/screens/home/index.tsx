...
export default function Home() {
    ...
    const startDrawing = (e: React.MouseEvent<HTMLCanvasElement>) => {
        ...
        if (canvas) {
            ...
            const ctx = canvas.getContext('2d');
            if (ctx) {
                lazyBrush.update({ x: e.nativeEvent.offsetX, y: e.nativeEvent.offsetY });
                ctx.beginPath();
                ctx.moveTo(lazyBrush.brush.x, lazyBrush.brush.y);
                setIsDrawing(true);
            }
        }
    };
    ...
    const draw = (e: React.MouseEvent<HTMLCanvasElement>) => {
        ...
        if (canvas) {
            ...
            if (ctx) {
                ...
                ctx.lineTo(lazyBrush.brush.x, lazyBrush.brush.y);
                ctx.stroke();
            }
        }
    };
